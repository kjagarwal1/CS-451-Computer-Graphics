...
public class kagarwal1_0_Point extends kagarwal_0_Frame {

	public kagarwal1_0_Point() { // 0. it calls super's constructor first
	...
	public static void main(String[] args) {
		kagarwal1_0_Point f = new kagarwal1_0_Point();
		f.setTitle("kagarwal1_1_Point: drawing a point");
