...
public class JOGL4_1_Blending extends JOGL3_11_Phong {
	  ...
	  float M_emission[] = {0.1f, 0.1f, 0.1f, 0.2f}; // Material property: emission 
	  float L_ambient[] = {0.2f, 0.2f, 0.2f, 1}; // Light source property: ambient 
	  float M_ambient[] = {0.2f, 0.2f, 0.2f, 0.2f}; // Material property: ambient 
	  float L_diffuse[] = {1, 1, 1, 1}; // Light source property: diffuse 
	  float M_diffuse[] = {.5f, 0.5f, 0.5f, 0.2f}; // Material property: diffuse 
			   ...
			   // enable blending for solar system
			    ...
			    myPushMatrix();
				    ...
				    myTranslatef(0.0f, 0.5f*E, 0.0f);
					    ...
					    drawCone(); // this cone is blocking 
				    myPopMatrix();
				    ...
				    myRotatef(90*dg, 1.0f, 0.0f, 0.0f); // orient the cone
				    drawCone(); // this cone may block the earth
				    myPopMatrix();
